...
villes=["Amiens", "Angouleme", "Avignon", "Bayonne", "Bilbao", "Bordeaux", "Bourges", "Brest", "Brive", "Bruxelles", "Caen", "Cahors", "Clermont-Ferrand", "Dijon", "Geneve", "Grenoble", "Lille", "Limoges", "Luxembourg", "Lyon", "Marseille", "Millau", "Montpellier", "Mulhouse", "Nancy", "Nantes", "Nice", "Orleans", "Paris", "Perpignan", "Poitiers", "Reims", "Rennes", "Rodez", "Rouen", "Saint-Etienne", "Strasbourg", "Toulouse", "Tours", "Troyes", "Valence"]
nbVilles=41

position=[(282,84), (180,334 ), (412,443 ), (140,455 ), (80,480 ), (165,389 ), (304,253 ), (14,150 ), (249,365 ), (380,15 ), (182,117 ), (258,412 ), (322,322 ), (408,231 ), (470,287 ), (464,359 ), (324,32 ), (242,332 ), (470,60 ), (405,306 ), (433,480 ), (339,440 ), (365,461 ), (497,208 ), (453,148 ), (116,233 ), (515,460 ), (277,194 ), (296,146 ), (329,505 ), (208,271 ), (369,119 ), (120,175 ), (330,410 ), (228,101 ), (383,339 ), (508,152 ), (227,466 ), (220,230 ), (363,179 ), (408,377 )]

position=[(u[0], 800-u[1]) for u in position]

longueur = [[0] * nbVilles for i in range(nbVilles)]
...
def dessinVilles(Points, Mat, Nom, color="C0",markersize=5):
    nbPoints=len(Points)
    Adj = [[] for i in range(nbPoints)]
    for x in range(nbPoints):
        for y in range(nbPoints):
            if Mat[x][y]!=np.inf and Mat[x][y]!=0:
                Adj[x].append(y)   
    fig, ax = plt.subplots()
    #__points(ax, Points, color, markersize)
    __aretes(ax, Points, Adj, color, markersize, 1)
    __points(ax, Points, "C3", markersize)
    for i in range(len(Points)):
        plt.text(Points[i][0]+10, Points[i][1]+10, Nom[i])
    plt.axis('equal')
    plt.show()
